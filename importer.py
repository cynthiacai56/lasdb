...
def main():
    ...
    parser_file.add_argument("-n", default="delft", help="the name of the point cloud")
    ...
    parser_file.add_argument("-n", default="south_holland", help="the name of the point cloud")
    parser_file.add_argument("-crs", default="EPSG:28992", help="the Spatial Coordinate System of the point cloud")
